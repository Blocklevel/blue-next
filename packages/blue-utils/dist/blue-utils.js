...
var capitalize = __webpack_require__(27),
...
var Vue = _interopDefault(__webpack_require__(34));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_camelCase__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex_connect__ = __webpack_require__(5);
...
var BlueUtils = function () {
  function BlueUtils(_ref) {
    var componentsContext = _ref.componentsContext,
        vuexContext = _ref.vuexContext;
  ...
  _createClass(BlueUtils, [{
    ...
    value: function mapComponents() {
      ...
      var filenames = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

      return this.componentsContext.keys().reduce(function (map, component) {
        var names = component.split('/');
        ...
        var key = __WEBPACK_IMPORTED_MODULE_0_lodash_camelCase___default()(name);

        if (map[key]) {
          throw new Error('[BlueUtils] Component ' + name + ' already exists. Please make sure to use unique names.');
        }

        return _extends({}, map, _defineProperty({}, key, _this.componentsContext(component)));
      }, {});
    }
    ...
    value: function connectComponent(name) {
      var connection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      var maps = this.mapComponents([name]);
      var keys = Object.keys(maps);

      if (!keys.length) {
        throw new Error('[BlueUtils] There is no ' + name + ' component listed in you application.');
      }

      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuex_connect__["connect"])(connection)(name, maps[keys[0]]);
    }
  }, {
    ...
    value: function registerStoreModules() {
      ...
      return this.vuexContext.keys().reduce(function (map, storeModule) {
        var name = storeModule.split('/')[1];
        return _extends({}, map, _defineProperty({}, name, _this2.vuexContext(storeModule).default));
      }, {});
    }
  }]);
...
var castSlice = __webpack_require__(15),
...
var basePropertyOf = __webpack_require__(12);
...
var asciiToArray = __webpack_require__(9),
    hasUnicode = __webpack_require__(2),
    unicodeToArray = __webpack_require__(25);
...
var toString = __webpack_require__(0),
    upperFirst = __webpack_require__(32);
...
var deburrLetter = __webpack_require__(18),
    toString = __webpack_require__(0);
...
var asciiWords = __webpack_require__(10),
